...
# able to skip for this particular project, found to be 9, hard code k_opt
...
write.csv(W, file.path(datadir,"NMF_W.csv"))
...
# export both individually, bind at regression step that are still in pixels
# these will be fairly large files
